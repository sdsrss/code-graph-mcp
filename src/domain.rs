...
pub fn is_cross_file_call_noise(name: &str, language: &str) -> bool {
    match language {
        ...
        "python" => CROSS_FILE_CALL_NOISE.contains(&name) || is_python_builtin_call_target(name),
