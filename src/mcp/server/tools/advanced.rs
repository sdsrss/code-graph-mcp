...
impl McpServer {
    pub(in crate::mcp::server) fn tool_trace_http_chain(
        ...
        let depth = arg_clamped(args, "depth", "find_http_route", 3)? as i32;
    ...
    pub(in crate::mcp::server) fn tool_dependency_graph(
        ...
        let depth = arg_clamped(args, "depth", "dependency_graph", 2)? as i32;
    ...
    pub(in crate::mcp::server) fn tool_find_similar_code(
        ...
        let top_k = arg_clamped(args, "top_k", "find_similar_code", 5)? as i64;
